...
.from.mi p{display:block !important;}
		...
		<div class="container">
<div class="col-md-5 visible-xs"><div class="to"><div class="row">
<div class="col-xs-offset-1 col-xs-10 visible-xs" style="height:20px;"></div>

<div class="col-xs-offset-1 col-xs-10 visible-xs" style="margin-bottom:10px;">
...
<div class="col-md-2 hidden-xs"><i style="font-size: 30px;padding-top: 100px;text-align:center;display:block;" class="glyphicon glyphicon-chevron-right"></i></div>
<div class="col-md-5 hidden-xs"><div class="to"><div class="row">
<div class="col-xs-offset-1 col-xs-10 hidden-xs" style="height:20px;"></div>

<div class="col-xs-offset-1 col-xs-10 hidden-xs" style="margin-bottom:10px;">
<h2>Информация о заказе</h2>
<table border=0>
<tr><td style="font-weight:bold;" align=right>Магазин:&nbsp;<td>
<tr><td style="font-weight:bold;" align=right>Валюта:&nbsp;<td>BCR
